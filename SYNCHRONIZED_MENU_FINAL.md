...
- **Нижнее меню**: 9 кнопок с дополнительными функциями (Random Deal, Ask Zabardoo, Language)
...
### 1. `scripts/inline-menu-zabardoo-bot.js` ⭐ ОБНОВЛЕН
- **Синхронизированные меню** - верхнее и нижнее одинаковые
- **Убраны лишние функции** (Random Deal, Ask Zabardoo, Language)
