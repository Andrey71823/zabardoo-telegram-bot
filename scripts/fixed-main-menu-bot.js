...
All features are available right from the main menu!
...
• Tap category buttons (📱 Electronics, 👗 Fashion, etc.)
• Type product names directly in chat

💰 *Getting Deals:*
• Tap "🔥 Hot Deals" for trending offers
• Use "💰 Cashback" to see cashback rates
• Check stores for specific shop deals
...
⚙️ *Settings & Profile:*
• "⚙️ Settings" to customize preferences
• "🎮 My Profile" to view your stats
• "🆘 Help" for support

📞 *Support:*
• Use this Help button anytime
