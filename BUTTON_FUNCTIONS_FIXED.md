...
Когда пользователь нажимал кнопку **"💬 Ask Zabardoo"** в нижнем меню, бот выдавал **неправильный ответ**:

```
❌ НЕПРАВИЛЬНО:
🔍 I found some relevant deals for: "💬 Ask Zabardoo"
📱 Top Results:
• Samsung Galaxy S24 - 28% OFF (₹52,000)
• iPhone 15 Pro - 15% OFF (₹1,20,000)
```

Вместо **правильной функции Ask Zabardoo**.
...
| 💬 Ask Zabardoo | Помощник для вопросов | ✅ Исправлено |
...
- Нажать **"💬 Ask Zabardoo"** → Должен показать помощника для вопросов
...
✅ **"💬 Ask Zabardoo"** теперь показывает:
```
💬 Ask Zabardoo
...
- ☐ 💬 Ask Zabardoo - показывает помощника для вопросов
...
- ✅ **"Ask Zabardoo"** теперь работает как помощник
...
### 📱 Файлы:
- **`scripts/inline-menu-zabardoo-bot.js`** - исправленный бот
