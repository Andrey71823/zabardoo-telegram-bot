...
(function(){
  ...
  ready(function(){
    ...
    function goHome(){ setActive(document.querySelector('.nav-link[data-action="home"]')); titleEl.innerHTML='<i class="fas fa-home"></i> Welcome to bazaarGuru Admin'; frameWrap.innerHTML='<iframe class="content-iframe" id="frame" name="frame" src="/dashboard.html"></iframe>'; }
