...
- 💬 **Ask Zabardoo** → выдавал поиск товаров вместо помощника
...
| 💬 **Ask Zabardoo** | `handleAskZabardoo()` | Помощник для вопросов |
...
✅ **💬 Ask Zabardoo** → Помощник для вопросов  
...
- **`scripts/inline-menu-zabardoo-bot.js`** - оригинальный (с проблемами)
